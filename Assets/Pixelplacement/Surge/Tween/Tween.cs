	...
	public class Tween
	{
		...
		public static TweenSystem.TweenEngine Instance
		{
			get
			{
				...
				{
					if (_instance == null)_instance = GameObject.FindObjectOfType<TweenEngine>();
					if (_instance == null)_instance = new GameObject("(Tween Engine)", typeof(TweenEngine)).GetComponent<TweenEngine>();
				}
				else
				{
					if (_instance == null) _instance = new GameObject("(Tween Engine)", typeof(TweenEngine)).GetComponent<TweenEngine>();
